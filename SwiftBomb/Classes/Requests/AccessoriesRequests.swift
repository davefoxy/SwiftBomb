...
extension SwiftBomb {
     ...
     */
    public static func fetchAccessories(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, completion: (PaginatedResults<AccessoryResource>?, error: RequestError?) -> Void) {
