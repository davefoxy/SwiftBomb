...
extension SwiftBomb {
     ...
     */
    public static func fetchCharacters(name: String? = nil, pagination: PaginationDefinition?, sort: SortDefinition?, fields: [String]? = nil, completion: (PaginatedResults<CharacterResource>?, error: RequestError?) -> Void) {
...
extension RequestFactory {
    ...
    func charactersRequest(name: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil) -> SwiftBombRequest {
