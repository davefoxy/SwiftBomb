...
extension SwiftBomb {
     ...
     */
    public static func fetchCompanies(_ query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil, completion: @escaping (PaginatedResults<CompanyResource>?, _ error: RequestError?) -> Void) {
