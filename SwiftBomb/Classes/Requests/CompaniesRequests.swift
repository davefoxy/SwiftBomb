...
extension SwiftBomb {
     ...
     */
    public static func fetchCompanies(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, completion: (PaginatedResults<CompanyResource>?, error: RequestError?) -> Void) {
