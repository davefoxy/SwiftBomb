...
extension SwiftBomb {
     ...
     */
    public static func fetchConcepts(_ query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil, completion: @escaping (PaginatedResults<ConceptResource>?, _ error: RequestError?) -> Void) {
