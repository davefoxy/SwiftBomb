...
extension SwiftBomb {
     ...
     */
    public static func fetchConcepts(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, completion: (PaginatedResults<ConceptResource>?, error: RequestError?) -> Void) {
