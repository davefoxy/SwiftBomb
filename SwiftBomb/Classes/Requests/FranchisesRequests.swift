...
extension SwiftBomb {
     ...
     */
    public static func fetchFranchises(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil, completion: (PaginatedResults<FranchiseResource>?, error: RequestError?) -> Void) {
...
extension RequestFactory {
    ...
    func franchisesRequest(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil) -> SwiftBombRequest {
