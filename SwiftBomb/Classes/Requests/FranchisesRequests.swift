...
extension SwiftBomb {
     ...
     */
    public static func fetchFranchises(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, completion: (PaginatedResults<FranchiseResource>?, error: RequestError?) -> Void) {
