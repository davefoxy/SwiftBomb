...
extension GBAPI {
    ...
    /**
     Retrieves a paginated list of `GBGameResource` instances. This list can be filtered to a search term, paginated and sorted.
     ...
     - Parameter completion: A closure returning an optional generic `GBAPIPaginatedResults` object containing the returned `GBGameResource` objects and pagination information and also, an optional `GBAPIError` object if the request failed.
     */
...
extension GBAPIRequestFactory {
    ...
    func gamesRequest(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil) -> GBAPIRequest {
        ...
        var request = GBAPIRequest(configuration: configuration, path: "games", method: .GET, pagination: pagination, sort: sort)
