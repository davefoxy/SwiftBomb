...
extension GBAPI {
    ...
    /**
     Retrieves a paginated list of `GBGenreResource` instances. This list can be filtered to a search term, paginated and sorted.
     ...
     - Parameter completion: A closure returning an optional generic `GBAPIPaginatedResults` object containing the returned `GBGenreResource` objects and pagination information and also, an optional `GBAPIError` object if the request failed.
     */
