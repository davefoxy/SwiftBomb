...
extension SwiftBomb {
     ...
     */
    public static func fetchGames(_ query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil, completion: @escaping (PaginatedResults<GameResource>?, _ error: RequestError?) -> Void) {
