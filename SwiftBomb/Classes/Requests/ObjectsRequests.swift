...
extension SwiftBomb {
     ...
     */
    public static func fetchObjects(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, completion: (PaginatedResults<ObjectResource>?, error: RequestError?) -> Void) {
