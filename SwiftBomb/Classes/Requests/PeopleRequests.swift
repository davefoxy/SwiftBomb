...
extension SwiftBomb {
     ...
     */
    public static func fetchPeople(_ query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil, completion: @escaping (PaginatedResults<PersonResource>?, _ error: RequestError?) -> Void) {
