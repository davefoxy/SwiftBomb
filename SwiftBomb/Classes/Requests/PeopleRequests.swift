...
extension SwiftBomb {
    ...
    /**
     ...
     - parameter completion: A closure returning an optional generic `PaginatedResults` object containing the returned `PersonResource` objects and pagination information and also, an optional `SwiftBombRequestError` object if the request failed.
     */
...
extension RequestFactory {
    ...
    func peopleRequest(_ query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil) -> SwiftBombRequest {
