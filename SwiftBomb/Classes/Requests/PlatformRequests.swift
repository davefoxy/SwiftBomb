...
extension SwiftBomb {
    ...
    /**
     ...
     - parameter completion: A closure returning an optional generic `PaginatedResults` object containing the returned `PlatformResource` objects and pagination information and also, an optional `SwiftBombRequestError` object if the request failed.
     */
