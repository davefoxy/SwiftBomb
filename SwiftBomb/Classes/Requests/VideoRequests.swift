...
extension SwiftBomb {
     ...
     */
    public static func fetchVideos(_ query: String?, pagination: PaginationDefinition?, sort: SortDefinition?, fields: [String]? = nil, completion: @escaping (PaginatedResults<VideoResource>?, _ error: RequestError?) -> Void) {
