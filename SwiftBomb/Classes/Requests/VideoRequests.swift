...
extension SwiftBomb {
    ...
    /**
     ...
     - parameter fields: An optional array of fields to return in the response. See the available options at http://www.giantbomb.com/api/documentation#toc-0-44. Pass nil to return everything.
     ...
     */
    public static func fetchVideos(query: String?, pagination: PaginationDefinition?, sort: SortDefinition?, fields: [String]? = nil, completion: (PaginatedResults<VideoResource>?, error: RequestError?) -> Void) {
        ...
        var request = requestFactory.videosRequest(query, pagination: pagination, sort: sort, fields: fields)
...
extension RequestFactory {
    ...
    func videosRequest(query: String? = nil, pagination: PaginationDefinition? = nil, sort: SortDefinition? = nil, fields: [String]? = nil) -> SwiftBombRequest {
...
extension VideoResource {
    ...
    public func fetchExtendedInfo(fields: [String]? = nil, completion: (error: RequestError?) -> Void) {
        ...
        guard
            ...
            let id = id,
            let request = api.requestFactory?.simpleRequest("video/\(id)/", fields: fields) else {
